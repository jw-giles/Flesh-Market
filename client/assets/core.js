...
window.I18N = {
  ...
  'galx.scanCircuit':{en:'FLESH STATION DEEP-SCAN REFUSED // {id}, {cls} // Circuit registry, nothing filed outside the passage',zh:'血肉站深层扫描被拒 // {id}，{cls} // 玉环注册舰体，环外不报关'},
  ...
  'casino.tab.mathgame':{en:'Math Quiz',zh:'数学题'},
  ...
  'casino.math.mathTest':{en:'MATH TEST',zh:'数学测试'},
  'casino.math.across':{en:'10 questions across all difficulties',zh:'涵盖所有难度的10道题'},
  'casino.math.qLabel':{en:'Q:',zh:'题：'},
  'casino.math.scoreLabel':{en:'Score:',zh:'得分：'},
  'casino.math.earnedLabel':{en:'Earned:',zh:'已赚：'},
  'casino.math.pressStart':{en:'Press Start Test to begin',zh:'按“开始测试”开始'},
  'casino.math.answer':{en:'Answer',zh:'回答'},
  'casino.math.startTest':{en:'▶ Start Test',zh:'▶ 开始测试'},
  'casino.math.inProgress':{en:'In Progress...',zh:'进行中…'},
  'casino.math.cooldown':{en:'⏳ {t} cooldown',zh:'⏳ 冷却 {t}'},
  'casino.math.badge':{en:'{lvl} · Ƒ{amt} reward',zh:'{lvl} · Ƒ{amt} 奖励'},
  'casino.math.lvlBasic':{en:'Basic',zh:'基础'},
  'casino.math.lvlStandard':{en:'Standard',zh:'标准'},
  'casino.math.lvlAdvanced':{en:'Advanced',zh:'进阶'},
  'casino.math.lvlExpert':{en:'Expert',zh:'专家'},
  'casino.math.lvlGenius':{en:'Genius',zh:'天才'},
  'casino.math.payoutPreview':{en:'Correct answer pays Ƒ{amt}',zh:'答对可得 Ƒ{amt}'},
  'casino.math.timeUp':{en:'⏱ Time up! Answer: {ans}',zh:'⏱ 时间到！答案：{ans}'},
  'casino.math.wrong':{en:'✗ Wrong, answer was {ans}',zh:'✗ 答错了，答案是 {ans}'},
  'casino.math.correct':{en:'✓ Correct! +Ƒ{amt}',zh:'✓ 答对！+Ƒ{amt}'},
  'casino.math.complete':{en:'Test complete!',zh:'测试完成！'},
  'casino.math.finalScore':{en:'Score: {score}/{total}, Total earned: Ƒ{earned}',zh:'得分：{score}/{total}，共赚 Ƒ{earned}'},
